...
public class Graph
{
    ...
    {
        // Have to look through nodes list to find node
    ...
    public bool AStar(GameObject startId, GameObject endId)
    {
        ...
        // g is the distance cost so far, g_score is if it was our next position distance - calculate it first
    ...
    {
        // Incase found was path previously
        pathList.Clear();
    ...
    // Holistic best guess of a* algorithm
